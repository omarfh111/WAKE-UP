...
void initEnemy(enemy *e)
{
    ...
    e->max_steps = 300;
    e->idle_time = 2500;
    e->x = (SCREEN_W / 2 - (e->img->w / 4) - 96 / 2) - 350; // screen width - (width of img / sprite size) - (width of sprite / 2)
    e->y = (SCREEN_H / 2 - (e->img->h / 4) - 96 / 2) + 460; // screen height - (height of img / sprite size) - (height of sprite / 2)
